...
(8, 3, NOW()-INTERVAL 10 DAY, NOW()-INTERVAL 3 DAY, 4, 5, 11, 14, 'ENDED', 107, 1),
(9, 3, NOW()+INTERVAL 1 DAY, NOW()+INTERVAL 3 DAY, 5, 5, 15, 14, 'CREATED', 108, 1),
(10, 3, NOW()+INTERVAL 5 DAY, NOW()+INTERVAL 10 DAY, 4, 2, 11, 5, 'CREATED', 109, 1);